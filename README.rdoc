...
Lets say :controller => 'messages', :action => 'show'

* simply define the following method in the messages helper
...
* This will generate the following namespaced call.
      ...
      SiteName.controller.action.init();

* In this case

      SiteName.messages.show.init();
